...
from rsMap3D.gui.rsmap3dsignals import CANCEL_LOAD_FILE_SIGNAL, LOAD_FILE_SIGNAL, UPDATE_PROGRESS_SIGNAL
...
class AbstractFileView(qtWidgets.QDialog):
    ...
    updateProgressSignal = qtCore.Signal(int, int, name=UPDATE_PROGRESS_SIGNAL)
