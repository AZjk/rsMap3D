...
from rsMap3D.datasource.s1highenergydiffractionds import S1HighEnergyDiffractionDS, S1ParameterFile
...
PAR_FILE1 = os.path.join(THIS_DIR, "../../fixtures/1-idscan/fastpar_startup_oct16_FF1.par")
PAR_FILE2 = os.path.join(THIS_DIR, "../../fixtures/1-idscan/fastpar_startup_oct16_FF1_with_comments.par")
PAR_FILE3 = os.path.join(THIS_DIR, "../../fixtures/1-idscan/fastpar_startup_oct16_FF1_with_blanks.par")
...
class Test(unittest.TestCase):
    def testParameterFileSimpleFile(self):
        ...
        self.assertEqual(GOOD_FILE_NUM_LINES, numLines, "Testing read of number Of lines")
    ...
    def testParameterFileWithBlankLines(self):
        ...
        self.assertEqual(
            GOOD_FILE_NUM_LINES,
            numLines,
            "Testing read of number Of lines " + str(GOOD_FILE_NUM_LINES) + "Expected, " + str(numLines) + " Read",
        )
