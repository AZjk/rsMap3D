...
class Sector12NSLSIISpecDataSource(SpecXMLDrivenDataSource):
    ...
    def loadSource(self, mapHKL=False):
        ...
        self.imageFileTmp = os.path.join(imageDir, TIFF_FILE_MERGE_STR % (self.projectName, self.projectName))
        ...
        try:
            ...
            for scan in self.scans:
                if self.cancelLoad:
                    ...
                    if os.path.exists(os.path.join(imagePath, SCAN_NUMBER_MERGE_STR % (self.projectName, scan))):
                        try:
                            ...
                            if self.mapHKL:
                                ...
                                if self.ubMatrix[scan] is None:
                                    raise Sector12SpecFileException("UB matrix " + "not found.")
                            else:
