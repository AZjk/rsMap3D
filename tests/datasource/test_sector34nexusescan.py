...
class Test(unittest.TestCase):
    ...
    def testComparePixel2XYZ(self):
        self.projectDir = os.path.join(THIS_DIR, "../fixtures/34-id-escan-compare")
        self.projectName = ""
        self.projectExtension = ".h5"
        self.detConfigFile = os.path.join(THIS_DIR, "../fixtures/34-id-escan-compare/geoN_2016-02-17_18-11-38.xml")
        appConfig = RSMap3DConfigParser()
        self.datasource = Sector34NexusEscanSource(
            self.projectDir, self.projectName, self.projectExtension, self.detConfigFile, appConfig=appConfig
        )
