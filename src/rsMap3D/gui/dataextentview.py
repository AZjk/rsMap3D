...
from rsMap3D.gui.rsm3dcommonstrings import XMAX_INDEX, XMIN_INDEX, YMAX_INDEX, YMIN_INDEX, ZMAX_INDEX, ZMIN_INDEX
...
class DataExtentView(qtWidgets.QFrame):
    ...
    def showRangeBounds(self, rangeBounds):
        ...
        axes.SetBounds(
            (
                rangeBounds[XMIN_INDEX],
                rangeBounds[XMAX_INDEX],
                rangeBounds[YMIN_INDEX],
                rangeBounds[YMAX_INDEX],
                rangeBounds[ZMIN_INDEX],
                rangeBounds[ZMAX_INDEX],
            )
        )
